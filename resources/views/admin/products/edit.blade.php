            ...
            <div class="card">
                <form action="{{ route('admin.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <h4>
                            <a href="{{route('admin.products.index')}}" style="color:#EE877C">Sản phẩm</a> > Sửa
                        </h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input name="name" type="text" class="form-control" placeholder="Tên..." value="{{ $product->name }}">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="tag[]" class="form-control tags-product-input" multiple="multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="price" type="number" class="form-control" placeholder="Giá..." value="{{ $product->price }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <img class="product-image-150-100" src="{{ asset($product->feature_image_path) }}" alt="">
                                </div>
                                ...
                                <div class="form-group">
                                    @foreach($product->images as $item)
                                        <img class="product-image-150-100 mr-2" src="{{ asset($item->image_path) }}" alt="">
                                    @endforeach
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea name="content_product" class="form-control product-content" rows="20">{{ $product->content }}</textarea>
                                </div>
