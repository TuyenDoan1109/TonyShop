            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4">Volup erat ipsum diam elitr rebum et dolor. Est nonumy elitr erat diam stet sit
                        ...
                        Nonumy</p>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Thông số: </strong>
                        @foreach($product_sizes as $product_size)
                            <p class="mr-3">{{$product_size}}</p>
                        @endforeach
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-primary px-3 mr-2 addWishlist"><i class="fas fa-heart mr-1"></i> Thêm vào yêu thích</button>
                        <button class="btn btn-primary px-3 addToCart"><i class="fa fa-shopping-cart mr-1"></i> Thêm vào giỏ hàng</button>
                    </div>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Đặc điểm nổi bật</a>
